    ...
    <Layout title="首頁" description="Docusaurus 靜態首頁">
      <main>
        ...
        <section style={{
          ...
          <img src={require('../../static/img/docusaurus.png').default} alt="Logo" style={{width: '120px', marginBottom: '2rem'}} />
        ...
        <section style={{
          ...
          <div style={{flex: '0 0 320px', textAlign: 'center'}}>
            <img src={require('../../static/img/undraw_docusaurus_tree.svg').default} alt="自然環境" style={{width: '220px'}} />
          </div>
        ...
        <section style={{padding: '4rem 0', background: '#fff'}}>
          ...
          <div style={{display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '2rem'}}>
            {[
              {src: require('../../static/img/logo.svg').default, alt: 'Partner 1', name: 'Partner 1'},
              {src: require('../../static/img/docusaurus.png').default, alt: 'Partner 2', name: 'Partner 2'},
              {src: require('../../static/img/undraw_docusaurus_mountain.svg').default, alt: 'Partner 3', name: 'Partner 3'},
              {src: require('../../static/img/undraw_docusaurus_tree.svg').default, alt: 'Partner 4', name: 'Partner 4'},
            ].map((partner, i) => (
              <div key={i} style={{
                background: '#f7f7f7',
                borderRadius: '16px',
                ...
                <img src={partner.src} alt={partner.alt} style={{width: '120px', marginBottom: '1rem'}} />
